...
public:
	CrossSpike();
	CrossSpike(int node_num, int delay);
	CrossSpike(FILE *f);
	~CrossSpike();

	int fetch(CrossNodeMap *map, int *tables, int *table_sizes, int table_cap, int node_num, int time, int max_delay, int min_delay, int delay);
	int update(int curr_delay);
	int upload(CrossNodeMap *map, int *tables, int *table_sizes, int table_cap, int node_num, int time, int max_delay, int min_delay, int delay);
